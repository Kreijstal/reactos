 ...
 * LICENSE:     ISC (upstream Atheros/Qualcomm terms, reproduced below)
 * PURPOSE:     Verbatim copy of Linux
 *              drivers/net/wireless/ath/ath9k/ar9003_phy.h.
 *
 * The AR9003-family baseband register map.  Vendored whole and unedited:
 * the file is pure #define with no includes and no type definitions, so
 * there is nothing to trim and a future cherry-pick diffs cleanly.
 * Register offsets and field masks for the PHY live here; the MAC/RTC
 * side lives in the sibling reg.h.
 */
