...
/* rtl8168h_config_eee_phy -- r8169_phy_config.c:84 */
static VOID
Rtl8168HConfigEeePhy(IN PRTL_ADAPTER A)
{
    Rtl8168GConfigEeePhy(A);
    RtlPhyModifyPaged(A, 0x0A4A, 0x11, 0x0000, 0x0200);
    RtlPhyModifyPaged(A, 0x0A42, 0x14, 0x0000, 0x0080);
}
    ...
    )
{
    ...
    case RTL_MAC_VER_33:
        RtlHwPhyConfig_E2(A);   /* close enough; e_1 needs firmware */
        break;
    ...
    case RTL_MAC_VER_36:    /* 8168F-2 -- close to F_1 minus the giga-green
                             * table tweaks; reuse F_1. */
        RtlHwPhyConfig_F1(A);
        break;

    case RTL_MAC_VER_38:    /* 8411 -- follows 8168F path */
    case RTL_MAC_VER_44:    /* 8411B */
        RtlHwPhyConfig_F1(A);
        break;
