...
@ cdecl mbedtls_ecp_group_init(ptr)
@ cdecl mbedtls_ecp_group_free(ptr)
@ cdecl mbedtls_ecp_point_init(ptr)
@ cdecl mbedtls_ecp_point_free(ptr)
@ cdecl mbedtls_ecp_keypair_init(ptr)
@ cdecl mbedtls_ecp_keypair_free(ptr)
