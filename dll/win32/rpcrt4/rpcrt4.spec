...
@ stdcall -arch=x86_64,arm64 NdrServerCallAll(ptr)
...
@ stdcall -version=0x600+ RpcExceptionFilter(long)
...
@ stdcall -stub RpcMgmtInqServerPrincNameA(ptr long ptr)
@ stdcall -stub RpcMgmtInqServerPrincNameW(ptr long ptr)
