...
@ stdcall -version=0x602+ NtAlertThreadByThreadId(ptr)
@ stdcall NtAlertThread(long)
@ stdcall NtAllocateLocallyUniqueId(ptr)
@ stdcall -version=0x601+ NtAllocateReserveObject(ptr ptr long)
...
@ stdcall NtLoadKeyEx(ptr ptr long ptr ptr long ptr ptr)
...
@ stdcall -version=0x601+ NtOpenKeyEx(ptr long ptr long)
...
@ stdcall -version=0x601+ NtSetIoCompletionEx(ptr ptr long long long long)
...
@ stdcall -version=0x602+ NtWaitForAlertByThreadId(ptr ptr)
...
@ stdcall -version=0x600+ RtlCreateProcessParametersEx(ptr ptr ptr ptr ptr ptr ptr ptr ptr ptr long)
...
@ stdcall -arch=arm64 RtlExtendedLargeIntegerDivide(double long ptr)
...
@ stdcall -arch=x86_64,arm64 -version=0x502-0x601 RtlGetCurrentDirectory_U(long ptr)
...
@ stdcall -arch=x86_64,arm64 RtlLookupFunctionEntry(long ptr ptr)
@ stdcall -arch=x86_64,arm64 RtlLookupFunctionTable(int64 ptr ptr)
...
@ stdcall -arch=i386,x86_64,arm64 RtlQueueApcWow64Thread(ptr ptr ptr ptr ptr)
...
@ stdcall -arch=x86_64,arm64 RtlRestoreContext(ptr ptr)
...
@ stdcall -arch=x86_64,arm64 RtlUnwindEx(ptr ptr ptr ptr ptr ptr)
...
@ stdcall -arch=x86_64,arm64 RtlVirtualUnwind(long int64 int64 ptr ptr ptr ptr ptr)
@ stdcall -version=0x602+ RtlWaitOnAddress(ptr ptr long ptr)
@ stdcall -version=0x602+ RtlWakeAddressAll(ptr)
@ stdcall -version=0x602+ RtlWakeAddressAllNoFence(ptr)
...
@ stdcall -version=0x600+ -arch=x86_64 RtlWow64GetThreadContext(ptr ptr)
@ stdcall -stub -version=0x600+ -arch=x86_64 RtlWow64LogMessageInEventLogger(long long long)
@ stdcall -version=0x600+ -arch=x86_64 RtlWow64SetThreadContext(ptr ptr)
...
@ stdcall -version=0x602+ ZwAlertThreadByThreadId(ptr)
@ stdcall ZwAlertThread(long)
@ stdcall ZwAllocateLocallyUniqueId(ptr)
@ stdcall -version=0x601+ ZwAllocateReserveObject(ptr ptr long)
...
@ stdcall -version=0x600+ ZwCancelIoFileEx(ptr ptr ptr)
...
@ stdcall -version=0x600+ ZwGetNextThread(ptr ptr long long long ptr) NtGetNextThread
...
@ stdcall -version=0x601+ ZwSetIoCompletionEx(ptr ptr long long long long)
...
@ stdcall -version=0x602+ ZwWaitForAlertByThreadId(ptr ptr)
...
@ cdecl _wtol(wstr)
@ cdecl abs(long)
@ cdecl -arch=i386,x86_64,arm64 atan(double)
@ cdecl atoi(str)
@ cdecl atol(str)
...
@ cdecl isxdigit(long)
@ cdecl labs(long)
@ cdecl -arch=i386,x86_64,arm64 log(double)
...
@ cdecl -arch=i386,x86_64,arm64 sqrt(double)
...
@ cdecl -arch=i386,x86_64,arm64 tan(double)
@ cdecl tolower(long)
