...
/* These declarations are now emitted into wlansvc_s.h because they are part
 * of the RPC interface.  Do not duplicate wlanapi.h's definitions here: the
 * generated header is included by precomp.h first. */
