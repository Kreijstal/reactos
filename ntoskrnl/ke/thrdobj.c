...
KeAlertResumeThread(IN PKTHREAD Thread)
{
    ...
    if (PreviousCount)
    {
        ...
        {
            /* Signal and satisfy. Win8 reworked the suspend mechanism:
             * the counted KSEMAPHORE was replaced with a binary
             * NotificationEvent (a single satisfied wait test releases
