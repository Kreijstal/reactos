...
@ stdcall FsRtlUpdateDiskCounters(int64 int64)
...
@ stdcall -arch=x86_64 KeExpandKernelStackAndCalloutEx(ptr ptr double long ptr)
...
@ stdcall PsUpdateDiskCounters(ptr int64 int64 long long long)
