...
@ stdcall -version=0x602+ IoSetDeviceInterfacePropertyData(ptr ptr long long long long ptr)
...
@ stdcall -version=0x602+ IoSetMasterIrpStatus(ptr long)
...
;@ stdcall -arch=x86_64,arm64 KeExpandKernelStackAndCallout(ptr ptr double)
...
@ stdcall -arch=x86_64 -version=0x600+ KeExpandKernelStackAndCalloutEx(ptr ptr long long ptr)
...
;@ cdecl -arch=x86_64,arm64 PsGetCurrentProcessWow64Process()
...
;@ cdecl -arch=x86_64,arm64 PsGetProcessWow64Process()
