...
@ stdcall -version=0x601+ CcCoherencyFlushAndPurgeCache(ptr ptr long ptr long)
...
@ stdcall -version=0x601+ CcCopyWriteWontFlush(ptr ptr long)
...
@ stdcall -version=0x601+ FsRtlAreThereCurrentOrInProgressFileLocks(ptr)
...
@ stdcall -version=0x600+ FsRtlGetEcpListFromIrp(ptr ptr)
@ stdcall FsRtlGetFileSize(ptr ptr)
@ stdcall FsRtlGetNextBaseMcbEntry(ptr long ptr ptr ptr)
@ stdcall -version=0x600+ FsRtlGetNextExtraCreateParameter(ptr ptr ptr ptr ptr)
...
@ stdcall -version=0x601+ FsRtlOplockBreakH(ptr ptr long ptr ptr ptr)
@ stdcall -version=0x601+ FsRtlOplockIsSharedRequest(ptr)
...
@ stdcall -version=0x600+ FsRtlValidateReparsePointBuffer(long ptr)
...
@ stdcall -version=0x602+ IoRetrievePriorityInfo(ptr ptr ptr ptr)
...
@ stdcall -version=0x600+ IoGetIrpExtraCreateParameter(ptr ptr)
...
; IoSetDeviceInterfacePropertyData (Win7+) - no impl yet; re-enable when backed by ntoskrnl(_vista)
...
; IoSetMasterIrpStatus (Win8+) - no impl yet; re-enable when backed by ntoskrnl(_vista)
...
@ stdcall -arch=x86_64 -version=0x600+ KeExpandKernelStackAndCalloutEx(ptr ptr double long ptr)
...
@ stdcall -version=0x601+ KeGetCurrentNodeNumber()
...
@ stdcall -version=0x601+ KeQueryHighestNodeNumber()
...
@ stdcall -version=0x601+ KeSetCoalescableTimer(ptr int64 long long ptr)
...
@ stdcall -version=0x601+ PoQueryWatchdogTime(ptr ptr)
