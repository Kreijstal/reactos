...
@ stdcall -arch=arm64 HalpConfigurePciRootBridge(ptr)
@ stdcall -arch=arm64 HalpRegisterPciRouteQuery(ptr)
@ stdcall -arch=arm64 HalpSetPciRoutingMap(ptr long)
@ stdcall -arch=arm64 HalpRecordPciMaxGsi(ptr)
