...
/* FileDispositionInformationEx / FILE_DISPOSITION_INFORMATION_EX is a Windows
 * 10 RS1 (1607) class.  ReactOS's Win10 target maps to NTDDI_WIN10 (the build
 * has no finer RS-level granularity), so it is gated there like every other
 * Win10-era feature in the tree. */
