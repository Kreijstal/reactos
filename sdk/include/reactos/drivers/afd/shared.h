...
#define AFD_SUPER_ACCEPT 36
#define IOCTL_AFD_SUPER_ACCEPT \
  _AFD_CONTROL_CODE(AFD_SUPER_ACCEPT, METHOD_BUFFERED)

#ifndef _AFD_SUPER_ACCEPT_DEFINED
#define _AFD_SUPER_ACCEPT_DEFINED
typedef struct _AFD_SUPER_ACCEPT_DATA
{
    HANDLE AcceptHandle;
    ULONG ReceiveDataLength;
    ULONG LocalAddressLength;
    ULONG RemoteAddressLength;
} AFD_SUPER_ACCEPT_DATA, *PAFD_SUPER_ACCEPT_DATA;
#endif
