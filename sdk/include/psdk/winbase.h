...
#endif
#if (_WIN32_WINNT >= 0x0600)
HANDLE WINAPI FindFirstFileNameW(_In_ LPCWSTR, _In_ DWORD, _Inout_ LPDWORD, _Out_ PWSTR);
BOOL WINAPI FindNextFileNameW(_In_ HANDLE, _Inout_ LPDWORD, _Out_ PWSTR);
#endif
