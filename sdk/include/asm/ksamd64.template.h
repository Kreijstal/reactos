...
CONSTANTX(CONTEXT_EX_LENGTH, 32),
...
HEADER("EPROCESS offsets"),
OFFSET(PrInstrumentationCallback, EPROCESS, InstrumentationCallback),

HEADER("ETHREAD offsets"),
OFFSET(EtInstrumentationCallback, ETHREAD, InstrumentationCallback),
