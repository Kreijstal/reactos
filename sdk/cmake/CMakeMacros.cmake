...
macro(dir_to_num dir var)
    ...
    elseif(${dir} STREQUAL reactos/SysWOW64)
        set(${var} 82)
    elseif(${dir} STREQUAL reactos/system32/lua)
        set(${var} 83)
    elseif(${dir} STREQUAL reactos/system32/lua/ops)
        set(${var} 84)
...
function(create_iso_lists)
    ...
    # No RAMDISK ISO is grafted into the BootCD: liveimg.iso is no longer
    # built (see boot_images.cmake), and the graft was disabled long before
    # that.  The LiveCD *file set* below is still merged into the BootCD.
