...
/* Only the i8042 scan-code translation tables and helpers remain here; the
   report parsing/accessor helpers were replaced by the "HidP KDR"
   implementation in parser.c and hidp.c. */
