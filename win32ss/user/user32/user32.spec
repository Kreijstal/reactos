...
@ stdcall -version=0x602+ AdjustWindowRectExForDpi(ptr long long long long)
@ stdcall -version=0x602+ AreDpiAwarenessContextsEqual(ptr ptr)
@ stdcall -version=0x602+ EnableNonClientDpiScaling(long)
@ stdcall -version=0x602+ GetDpiForWindow(long)
@ stdcall -version=0x602+ GetSystemMetricsForDpi(long long)
@ stdcall -version=0x602+ GetThreadDpiAwarenessContext()
@ stdcall -version=0x602+ GetWindowDpiAwarenessContext(long)
